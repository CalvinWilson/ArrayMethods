...
document.getElementById("Answer1").innerHTML = "$" + final;

//Question 2

var select = items.filter(function(item){
...
var names = select.forEach(function(item){
  document.getElementById("Answer2").innerHTML += "<p>"+item.title+"</p>";
}); 
...
var CurrnencyPrice =currency.forEach(function(item){
  document.getElementById("Answer3").innerHTML = item.title + " costs"+ " " + "£" + item.price;
}); 

//Question 4 

var wood = items.filter(function(item){
  var isMadeOfWood = false;
  ...
  var woodnames = wood.forEach(function(item){
   document.getElementById("Answer4").innerHTML += "<p>"+item.title+ " " + "is made of wood"+"</p>"
}); 
...
var eight = items.filter(function(item){
  ...
  var EightName = eight.forEach(function(item){
   document.getElementById("Answer5").innerHTML += "<p>"+item.title+"</p>"
   document.getElementById("Answer5").innerHTML += "<p>"+item.materials.join("<br>")+"<p>"
});
...
var homemade = items.forEach(function(item){
  document.getElementById("Answer6").innerHTML = "<p>"+selfmade.length+ " " + "items were made by their sellers" + "</p>";
});
